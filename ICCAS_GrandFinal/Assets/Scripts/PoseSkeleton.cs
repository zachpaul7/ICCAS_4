...
public class PoseSkeleton
{
    ...
    public PoseSkeleton(Transform parents, float pointScale = 10f, float lineWidth = 5f)
    {
        ...
        for (int i = 0; i < NUM_KEYPOINTS; i++)
        {
            ...
            this.keypoints[i].parent = parents;
        }
    ...
    private void InitializeLine(int pairIndex, float width, Color color, Transform parents)
    {
        ...
        lines[pairIndex].transform.parent = parents;
    }

    /// <summary>
    /// Initialize the pose skeleton
    /// </summary>
    private void InitializeSkeleton(Transform parents)
    {
        for (int i = 0; i < jointPairs.Length; i++)
        {
            InitializeLine(i, lineWidth, colors[i], parents);
        }
    }
